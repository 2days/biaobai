...
<body>
	<div class="flowtime">
		<div class="ft-section section-1" data-id="section-1">
			<div id="/section-1/page-1" class="ft-page page-1" data-id="page-1">
				<p class="text1"><span id="text-75" contenteditable="false">小明</span> ❤ <span id="text-76" contenteditable="false">小红</span> <span id="text-77" contenteditable="false">一生一世</span></p>
				<p class="text2">按键盘 "↓" <span id="text-78" contenteditable="false">开始倾听我的表白</span></p>
			</div>
			<div id="/section-1/page-2" class="ft-page page-2" data-id="page-2">
				<p class="top-text" id="text-1" contenteditable="false">过去的小明一直是一个人生活，享受着孤独，也憧憬着爱情。</p>
		...
		<div class="ft-section section-3" data-id="section-3">
			...
			<div id="/section-3/page-3" class="ft-page page-13" data-id="page-3">
				...
				<h3 id="text-13" contenteditable="false">可是小明的爱情又在哪里呢？</h3>
			</div>
			...
			<div id="/section-3/page-6" class="ft-page page-16 left-img" data-id="page-6">
				<h3><span id="text-17" contenteditable="false">于是，小明一个人继续向前走</span><br /><span id="text-18" contenteditable="false">走在茫茫的雪地上</span></h3>
				<img src='img/iali66.jpg' />
			</div>
			<div id="/section-3/page-7" class="ft-page page-17 top-text" data-id="page-7">
				<h3 id="text-19" contenteditable="false">直到有一天小明与小红相遇了</h3>
		...
		<div class="ft-section section-5" data-id="section-5">
			...
			<div id="/section-5/page-7" class="ft-page page-31" data-id="page-7">
				<h3 id="text-34" contenteditable="false">于是小明开始学习新的技能</h3>
		...
		<div class="ft-section section-6" data-id="section-6">
			...
			<div id="/section-6/page-4" class="ft-page page-35" data-id="page-4">
				<h3><span id="text-38" contenteditable="false">小明感觉自己好幸福。</span><br /><span id="text-39" contenteditable="false">因为自己有了家</span><br /><span id="text-40" contenteditable="false">那个有小红在的地方</span></h3>
		...
		<div class="ft-section section-7" data-id="section-7">
			...
			<div id="/section-7/page-3" class="ft-page page-41" data-id="page-3">
				...
				<h3 id="text-46" contenteditable="false"> 小明又怎会飞的更高更远</h3>
			</div>
			<div id="/section-7/page-4" class="ft-page page-42" data-id="page-4">
				<h3><span id="text-47" contenteditable="false">小明不想这样。他要为小红改变自己</span><br /><span id="text-48" contenteditable="false">小红说她喜欢狮子座的人，于是小明许下愿望</span></h3>
				<img src='img/iali69.jpg'  />
			</div>
			<div id="/section-7/page-5" class="ft-page page-43" data-id="page-5">
				<img src='img/iali42.jpg' />
				<h3 id="text-49" contenteditable="false">我愿为你变成狮子座</h3>
			</div>
			...
			<div id="/section-7/page-7" class="ft-page page-45 left-img" data-id="page-7">
				<h3><span id="text-52" contenteditable="false">再到后来，小红要过生日了</span><br /><span id="text-53" contenteditable="false">小明开始为小红准备礼物</span></h3>
		...
		<div class="ft-section section-8" data-id="section-8">
			<div id="/section-8/page-1" class="ft-page page-46" data-id="page-1">
				...
				<h3>
					<span id="text-54" contenteditable="false">看着礼物一件件准备好了</span>
					<span id="text-55" contenteditable="false">小明好开心</span>
					<span id="text-56" contenteditable="false">因为他想象着小红收到礼物时</span>
					<span id="text-57" contenteditable="false">开心的样子</span>
				</h3>
			</div>
			<div id="/section-8/page-2" class="ft-page page-47 top-text" data-id="page-2">
				...
				<h3>
					...
					<span id="text-59" contenteditable="false">小明好开心</span>
					<span id="text-60" contenteditable="false">因为可以和小红</span>
			...
			<div id="/section-8/page-3" class="ft-page page-48 left-img" data-id="page-3">
				<p><span id="text-62" contenteditable="false">小明也会继续努力</span><br /><span id="text-63" contenteditable="false">为了他和小红的梦之城堡</span></p>
				<img src='img/iali65.jpg'  />
			</div>
			<div id="/section-8/page-4" class="ft-page page-49 full-img" data-id="page-4">
			<img src='img/iali71.jpg' />
				<p class="text">
					<span class='text' id="text-64" contenteditable="false">小明很幸福，因为他找到了小红。他相信后面的每天都会是快乐的</span><br />
					<span class='text' id="text-65" contenteditable="false">简简单单，体会着与小红在一起的每一个刻</span>
				</p>
			</div>
			<div id="/section-8/page-5" class="ft-page page-50" data-id="page-5">
				<p class='text' id="text-66" contenteditable="false">后来的一天，小红说她不敢坐山车了，于是小明就带她到别的地方玩。这只是他们幸福生活中的一件小事，小到无法引起别人的注意。可这是属于小明和小红的幸福生活。</p>
			...
			<div id="/section-8/page-6" class="ft-page page-51" data-id="page-6">
				<p>
					<span id="text-67" contenteditable="false">小红：永远有多远？</span><br />
					<span id="text-68" contenteditable="false">小明：比时间多一秒就是永远，我会永远爱你</span><br />
					<span id="text-69" contenteditable="false">小红：世界有多大？</span><br />
					<span id="text-70" contenteditable="false">小明：你走到哪里，世界就有多大</span>
					</p>
			</div>
		</div>
		<div class="ft-section section-9" data-id="section-9">
			...
			<div id="/section-9/page-2" class="ft-page page-53" data-id="page-2">
				...
				<h3 id="text-72" contenteditable="false">情人节快乐</h3>
			</div>
			...
			<div id="/section-9/page-4" class="ft-page page-55 right-img" data-id="page-4">
				...
				<p class="text">
					<span id="text-73" contenteditable="false">小明和小红的故事会一直继续下去。</span><br />
	...
	<div class="write-ok">
		<div class="write-box">
			<h2>还差一步即可生成表白页面</h2>
			<p id="write-mp3">自定义背景音乐：<span id="text-music" contenteditable="false">http://<?php echo $_SERVER['HTTP_HOST']; ?>/love/music/saveme</span><i></i>.mp3</p>
			<p id="write-url">自定义表白链接：<u>http://<?php echo $_SERVER['HTTP_HOST']; ?>/love/2014/</u><span id="text-href" contenteditable="false"><?php echo time(); ?></span><i></i><u>.html</u></p>
